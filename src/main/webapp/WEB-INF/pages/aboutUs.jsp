	...
	<div class="row" style="margin-top:4px; margin-right:0px; margin-left:0px;margin-bottom:19px ">
		<div class="col-sm-4" style="margin-top:0px">
			<div class="container-fluid bg-1 text-center">
				<h3>Who Am I?</h3>
				<img src="<c:url value="/resources/images/aboutImage.png"/>" class="img-circle" alt="AboutUs" width="350"
					height="350">
				<h3>GoldieShopping a WorldWide E-Commerce Site</h3>
			</div>
		...
		<div class="container-fluid bg-2 text-center">
			<h3>What are we?</h3>
			<div id="para"><p>GoldieShopping's vision is to create world's most reliable and
				frictionless commerce ecosystem that creates life-changing
				experiences for buyers and sellers of gold & jewellery.</p>
			</div>
